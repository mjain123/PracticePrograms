...
import com.ncsu.rotatearrayfind;

/**
 * The class <code>rotatearrayfindTest</code> contains tests for the class <code>{@link rotatearrayfind}</code>.
 *
 * @generatedBy CodePro at 3/9/15 10:34 PM
 * @author Mohit
 * @version $Revision: 1.0 $
 */
public class rotatearrayfindTest {
	/**
	...
	public static void main(String[] args) {
		new org.junit.runner.JUnitCore().run(rotatearrayfindTest.class);
	}
}