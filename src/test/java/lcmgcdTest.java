...
import com.ncsu.lcmgcd;

/**
 * The class <code>lcmgcdTest</code> contains tests for the class <code>{@link lcmgcd}</code>.
 *
...
public class lcmgcdTest {
	...
	public static void main(String[] args) {
		new org.junit.runner.JUnitCore().run(lcmgcdTest.class);
	}
}